...
% p = 4/100; b=500; d=900; MEd=4991000000; VEd=1039000;
% z = 900-0.42*900=522
% v1 = 0.60*(1-20/250)= 0.552
% VRdmax = 0.552*11.33*500*522/(tan(30)+cot(30))= 704951
% As = (4/100)*500*900= 18000
% w = (18000/500*900)*348/11.33= 1.2286
% C = 500*900+(36)*18000= 1098000
% C20/25 beton ve S400 çelik kullanılacaktır.

fck=20; fcd=11.33; fyk=400; fyd=348;
Es=2*10^5; theta= 30; birimMaliyetOrani = 36;
MEd=4991000000; VEd=1039000;
